...
# Usage example:  python3 main.py --list=grocery.txt --video=test.mp4     <--VIDEO
#                 python3 main.py --list=grocery.txt --image=test.jpg     <--IMAGE
#                 python3 main.py --list=grocery.txt                      <--WEBCAM
